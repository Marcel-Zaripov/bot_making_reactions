...
// help docs
var description = `
This skill primary task is to collect inforamtion about reactions added to users from the database. 
The important note here: bot queries for name of the user from its storage, thus it is important that the user was introduced to bot 
with either welcome in or when joining to the same channel as bot. Then, on sending “report” or “stats” by direct message 
or with direct / indirect mention, the bot will respond with total score of the user.
`;
var help = {
    name: "reporting",
    ...
    commands: [
        {
            ...
            description: [
                ...
                "For now it is just sum, but maybe later you will see something like what reactions in what quantity you got:wink:"
            ],
            short: "shows stats up to this point",

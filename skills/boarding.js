...
// help docs
var description = `
The set of functions that ensures that bot is acquainted with channel users (i.e. their names and ids are saved to bot’s storage) 
in order to avoid querying slack api every time the score is updated in the praise message. 
The corner case is if either the bot was in the channel before being deployed / while being offline, 
or a new user connected to the channel while the bot was offline. To cover this up the function of “welcoming” is introduced, 
which works this way: send “welcome” + either direct or indirect mention of bot user, e.g. “welcome @reactionbot” or “@reactionbot welcome”.
(punctuation or any other words do not matter, what triggers it is keyword welcome and mention of bot user)
`;
var help = {
    name: "boarding",
    ...
    commands: [
        {
            ...
            short: "gathers information about users in current channel",
